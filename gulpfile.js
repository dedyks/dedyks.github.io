...
gulp.task('vendor', gulp.parallel(vendorBootstrap, vendorFontAwesome, vendorJquery, vendorJqueryEasing));
...
gulp.task('css:minify', gulp.series('css:compile', cssMinify));
...
// Dev task
gulp.task('dev', gulp.series('css', 'js', 'browserSync', function watch() {
